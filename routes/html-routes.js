...
module.exports = function (app) {
  app.get("/", (req, res) => {
    db.Product.findAll({ group: "subCategory" }).then((allProducts) => {
      ...
      if (accessLevel >= ADMIN_LEVEL) admin = true;
      else admin = false;
  ...
  app.get("/admin", function (req, res) {
    db.Product.findAll({ group: "subCategory" }).then((allProducts) => {
      if (req.user) {
        ...
        res.render("adminhome", { allProducts, admin, loggedIn: accessLevel });
      } else res.render("login", {});
    });
  });
  ...
  app.get("/cart", function (req, res) {
    db.Product.findAll({ group: "subCategory" }).then((allProducts) => {
      ...
      res.render("cart", { admin, allProducts, loggedIn: accessLevel });
    });
  });
  ...
  app.get("/checkout/thankyou", function (req, res) {
    db.Product.findAll({ group: "subCategory" }).then((allProducts) => {
      ...
      res.render("thankyou", { admin, allProducts, loggedIn: accessLevel });
    });
  });
